    ...
    <div class="max-w-6xl mx-auto px-4 py-6 md:px-8 space-y-8">
        ...
        <div class="animate-slideIn section-delay-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                ...
                {{-- Blog --}}
                <a href="{{ route('blog.index') }}" class="group card-delay-5 animate-slideIn bg-white/5 backdrop-blur-lg rounded-2xl border border-purple-500/20 hover:border-sky-400/40 p-4 hover:shadow-lg hover:shadow-sky-500/10 transition-all duration-200 hover:-translate-y-0.5">
