...
>
    ...
    >
        <div class="ps-3 pe-4">
            <i data-lucide="chevron-down" class="hidden size-3 group-data-open/disclosure-button:block"></i>
            <i data-lucide="chevron-right" class="block size-3 group-data-open/disclosure-button:hidden"></i>
        </div>
